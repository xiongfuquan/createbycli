...
class MyMap extends Component {
  ...
  async componentDidMount() {
    ...
    const tdtImageLayer = new WebTileLayer({
      urlTemplate:
        "http://t0.tianditu.gov.cn/DataServer?T=img_c&x={col}&y={row}&l={level}&tk=6fa7dcb903d71213f87ddedf1726e8bb",
      tileInfo,
      visible: true,
      id: "tdtImgLayer",
    ...
    const tdtNotationLayer = new WebTileLayer({
      urlTemplate:
        "http://t0.tianditu.gov.cn/DataServer?T=cva_c&x={col}&y={row}&l={level}&tk=6fa7dcb903d71213f87ddedf1726e8bb",
      tileInfo,
      visible: true,
      id: "tdtCvaLayer",
      maxScale: 2254.4677204799655
    ...
    const webMap = new WebMap({
      basemap: {
        baseLayers: [tdtImageLayer, tdtNotationLayer]
      }
    });
